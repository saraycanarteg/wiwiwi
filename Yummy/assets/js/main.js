...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function obtenerImagenProducto(nombre) {
    const productos = {
      ...
      "Café rose": "assets/img/menu/be_ca_4-removebg-preview.png",
      "Café daroma": "assets/img/menu/be_ca_5-removebg-preview.png",
      "flat white": "assets/img/menu/be_ca_6-removebg-preview.png",
      "Desayuno frances": "assets/img/menu/pl_fr_1-removebg-preview.png",
      "Desayuno Continental": "assets/img/menu/pl_fr_3-removebg-preview.png",
      "Desayuno Diamonds": "assets/img/menu/pl_fr_2-removebg-preview.png",
