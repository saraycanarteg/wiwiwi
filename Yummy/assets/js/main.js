...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function obtenerImagenProducto(nombre) {
    const productos = {
      ...
      "Café bombón": "assets/img/menu/be_ca_1-removebg-preview.png",
      "Latte": "assets/img/menu/be_ca_2-removebg-preview.png",
      "Café au Lait": "assets/img/menu/be_ca_3-removebg-preview.png",
      "Cafe rose": "assets/img/menu/be_ca_4-removebg-preview.png",
      "Cafe daroma": "assets/img/menu/be_ca_5-removebg-preview.png",
      "flat white": "assets/img/menu/be_ca_6-removebg-preview.png",
      "Desayuno frances": "assets/img/menu/pl_fr_1-removebg-preview.png",
      "Desayuno Diamonds": "assets/img/menu/pl_di_1-removebg-preview.png",
      "Desayuno Diamonds": "assets/img/menu/pl_di_2-removebg-preview.png",
      "Desayuno Continental": "assets/img/menu/pl_co_1-removebg-preview.png",
      "Desayuno Irlandés": "assets/img/menu/pl_ir_1-removebg-preview.png",
      "Desayuno healthy": "assets/img/menu/pl_he_1-removebg-preview.png",
      "Bolon de verde": "assets/img/menu/menu-item-1.png",
