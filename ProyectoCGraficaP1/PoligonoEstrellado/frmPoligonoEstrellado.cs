...
namespace PoligonoEstrellado
{
    ...
    {
        private static frmPoligonoEstrellado instancia;

        public static frmPoligonoEstrellado Instancia
        {
            get
            {
                if (instancia == null || instancia.IsDisposed)
                    instancia = new frmPoligonoEstrellado();
                return instancia;
            }
        }
        ...
        private PoligonoEstrellado poligonoEstrellado;
        ...
        public void dibujarPoligonoEstrellado()
        {
            PoligonoEstrellado poligonoEstrellado = new PoligonoEstrellado();
            ...
            poligonoEstrellado.DibujarPoligonoEstrellado(g, altura, transformacion, (float)centroX, (float)centroY,
                checkCoordenadas.Checked);

            g.Dispose();
            double alturaEscalada = altura * transformacion.Escala;
            txtArea.Text = poligonoEstrellado.CalcularArea(alturaEscalada).ToString("F2");
            txtPerimetro.Text = poligonoEstrellado.CalcularPerimetro(alturaEscalada).ToString("F2");
        }
